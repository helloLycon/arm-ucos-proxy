...
#define OS_MAX_EVENTS            100u   /*系统最大事件数 Max. number of event control blocks in your application      */
#define OS_MAX_FLAGS              40u   /*系统最大的信号量集数Max. number of Event Flag Groups    in your application      */
#define OS_MAX_MEM_PART           16u   /*内存块数目 Max. number of memory partitions                             */
...
#define OS_TICKS_PER_SEC       	500u   /* 设置1s时间的节拍数 Set the number of ticks in one second                        */
